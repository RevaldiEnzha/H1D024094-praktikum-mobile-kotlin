package com.pemmob.jualan.data.dummy

import com.pemmob.jualan.data.model.Category
import com.pemmob.jualan.data.model.Product
...
object DummyData {
    val categories = listOf(
        ...
        Category(id=3, name="Kerajinan", description = "Kerjinan Tangan", products_count = 5),
    )
    ...
    val products = listOf(
        ...
        Product(3, 1, categories[0], "Sale Pisang", "Sale pisang manis", 25000.0, 10, "dummy_product"),
        Product(4, 1, categories[0], "Getuk Goreng", "Getuk khas", 30000.0, 40, "dummy_product"),
        Product(5, 1, categories[0], "Nonia", "Nonia rasa coklat", 22000.0, 60, "dummy_product"),
        ...
        Product(14, 3, categories[2], "Gantungan Kunci", "Gantungan kayu", 5000.0, 100, "dummy_product"),
